    ...
    Share.prototype.init = function() {
        ...
        _this.core.$el.on('onAfterSlide.lg.tm', function(event, prevIndex, index) {
            ...
            setTimeout(function() {
                ...
                $('#lg-share-facebook').attr('href', 'https://www.facebook.com/profile.php?id=100091310641682sharer/sharer.php?u=' + (encodeURIComponent(_this.getSahreProps(index, 'facebookShareUrl') || window.location.href)));
